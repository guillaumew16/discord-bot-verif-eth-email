...
${token}
If you did not join the Discord server ${theGuild.name} and tell me your nethz, then someone else provided your nethz. Then you don't need to do anything; the token will expire in 24 hours.
